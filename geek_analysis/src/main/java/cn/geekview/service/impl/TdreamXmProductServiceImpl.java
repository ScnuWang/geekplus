...
public class TdreamXmProductServiceImpl {
    ...
    public void analysis(Date updateDateTime){
        ...
        TdreamWebsite website_totalAmount = websiteService.queryByUpdateDateTimeAndwebsiteId(Constant.WEBSITE_ID_XIAOMI,new DateTime(updateDateTime).plusDays(-1).toDate());
        //日增长金额
