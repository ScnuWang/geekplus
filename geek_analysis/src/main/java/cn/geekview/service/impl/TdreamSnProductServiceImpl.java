...
public class TdreamSnProductServiceImpl {
    ...
    public void insertOrUpdateProductTable(Integer crawlFrequency , Date updateDateTime){
        ...
        List<TdreamSnProduct> products = productPrimaryMapper.queryProduct_Newest(date.plusMinutes(-crawlFrequency/2).toDate(),date.plusMinutes(crawlFrequency/2).toDate());
