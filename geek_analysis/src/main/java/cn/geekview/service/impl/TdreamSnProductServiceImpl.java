...
public class TdreamSnProductServiceImpl {
    ...
    public void analysis(Date updateDateTime){
        ...
        //成功的项目个数
        Integer successProductCounts  = productService.queryProductsAndStatusByWebsiteId(Constant.WEBSITE_ID_SUNING,Constant.FUNDING_STATUAS_SUCCESS);
        //平均完成率
        ...
        TdreamWebsite website_totalAmount = websiteService.queryTotalAmountByUpdateDateTimeAndwebsiteId(Constant.WEBSITE_ID_SUNING,new DateTime(updateDateTime).plusDays(-1).toDate());
        //日增长金额
