...
public class TdreamTbProductServiceImpl {
    ...
    public void websiteDataProcess(){
        ...
        TdreamWebsite website_totalAmount = websiteService.queryByUpdateDateTimeAndwebsiteId(Constant.WEBSITE_ID_TAOBAO,updateDateTime.plusDays(-1).toDate());
        //日增长金额
     ...
     * @return
     */
    public List<TdreamTbProduct> queryProductPriceTrend(Integer crawlFrequence,String orignalId){
