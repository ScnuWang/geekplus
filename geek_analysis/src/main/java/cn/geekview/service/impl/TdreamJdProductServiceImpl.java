...
public class TdreamJdProductServiceImpl {
    ...
    public void websiteDataProcess(){
        ...
        //成功的项目个数
        Integer successProductCounts  = productService.queryProductsByWebsiteIdAndStatus(Constant.WEBSITE_ID_JINGDONG,Constant.FUNDING_STATUAS_SUCCESS);
        Integer fildProductCounts = productService.queryProductsByWebsiteIdAndStatus(Constant.WEBSITE_ID_JINGDONG,Constant.FUNDING_STATUAS_FAIL);
        ...
        TdreamWebsite website_totalAmount = websiteService.queryByUpdateDateTimeAndwebsiteId(Constant.WEBSITE_ID_JINGDONG,updateDateTime.plusDays(-1).toDate());
        //日增长金额
     ...
     * @return
     */
    public List<TdreamJdProduct> queryProductPriceTrend(Integer crawlFrequence,String orignalId){
