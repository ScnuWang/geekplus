...
public interface TdreamJdProductMapper {
    String insert = "insert into t_dream_jd_product (pk_id, original_id, crawl_frequency, \n" +
    ...
    int insert(TdreamJdProduct product);
