...
public interface TdreamXmProductMapper {
    String insert = "insert into t_dream_xm_product (pk_id, original_id, crawl_frequency, \n" +
    ...
    int insert(TdreamXmProduct product);
