...
public interface TdreamSnProductMapper {
    String insert = "insert into t_dream_sn_product (pk_id, original_id, crawl_frequency, \n" +
    ...
    int insert(TdreamSnProduct product);
